...
@Component
public class PanVerificationAdapter implements VerificationProviderPort {

    @Override
    public VerificationResult submitRequest(UUID userId, String code, String correlationId) {
        throw new UnsupportedOperationException("PAN verification integration is not yet implemented.");
    }

    @Override
    public VerificationResult checkStatus(String providerReference, String correlationId) {
        throw new UnsupportedOperationException("PAN status check is not yet implemented.");
    }

    @Override
    public VerificationResult fetchResult(String providerReference, String correlationId) {
        throw new UnsupportedOperationException("PAN result retrieval is not yet implemented.");
    }
    ...
    public String getProviderMetadata() {
        return "PAN verification API integration placeholder";
    }
    ...
    public VerificationProvider getProviderType() {
        return VerificationProvider.PAN;
    }
}
