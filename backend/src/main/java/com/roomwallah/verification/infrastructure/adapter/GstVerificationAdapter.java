...
@Component
public class GstVerificationAdapter implements VerificationProviderPort {

    @Override
    public VerificationResult submitRequest(UUID userId, String code, String correlationId) {
        throw new UnsupportedOperationException("GST verification integration is not yet implemented.");
    }

    @Override
    public VerificationResult checkStatus(String providerReference, String correlationId) {
        throw new UnsupportedOperationException("GST status check is not yet implemented.");
    }

    @Override
    public VerificationResult fetchResult(String providerReference, String correlationId) {
        throw new UnsupportedOperationException("GST result retrieval is not yet implemented.");
    }
    ...
    public String getProviderMetadata() {
        return "GST verification API integration placeholder";
    }
    ...
    public VerificationProvider getProviderType() {
        return VerificationProvider.GST;
    }
}
